    ...
    <div className="flex flex-col gap-16 font-sans animate-in fade-in duration-700">
      ...
      <section>
        <div className="flex items-center justify-between mb-8">
           ...
           <span className="font-mono text-[9px] text-archive-mute uppercase tracking-widest hidden sm:block">CATALOG_ID: DX22P</span>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           ...
           <div className="group cursor-pointer">
              <div className="h-48 md:h-[220px] bg-archive-border relative overflow-hidden mb-4 border border-archive-border group-hover:border-archive-cyan/40 transition-colors glow-border glow-border-tl">
                 ...
                 {/* Duration Badge */}
                 <div className="absolute bottom-3 left-3 bg-black/80 font-mono text-[9px] text-white px-2 py-1 border border-archive-border">14:22 // 4K</div>
              </div>
           ...
           <div className="group cursor-pointer">
              <div className="h-48 md:h-[220px] bg-archive-border relative overflow-hidden mb-4 border border-archive-border group-hover:border-archive-cyan/40 transition-colors glow-border glow-border-tl">
                 ...
                 {/* Duration Badge */}
                 <div className="absolute bottom-3 left-3 bg-black/80 font-mono text-[9px] text-white px-2 py-1 border border-archive-border">06:45 // 4K</div>
              </div>
      ...
      <section className="mb-12">
        <div className="flex items-center justify-between mb-8 border-b border-archive-border pb-4">
           ...
           <span className="font-mono text-[9px] text-archive-mute uppercase tracking-widest">ENTRIES: 124</span>
        </div>
        ...
        <div className="flex flex-col gap-0 border-y border-archive-border">
           ...
           <article className="grid grid-cols-1 md:grid-cols-12 gap-4 py-8 border-b border-archive-border hover:bg-archive-gray/30 transition-colors group px-4 -mx-4">
              <div className="md:col-span-3 flex flex-col font-mono text-[10px] mt-1 space-y-1">
              ...
              <div className="md:col-span-9">
                 ...
                 <button className="font-mono text-[10px] text-archive-cyan uppercase tracking-widest flex items-center gap-2 hover:text-white transition-colors">
