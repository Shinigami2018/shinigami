          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {videos.map((video: YouTubeVideo) => (
              ...
              >
                ...
                <h3 className="font-mono text-xs font-bold uppercase tracking-wide group-hover:text-archive-cyan transition-colors line-clamp-2 leading-snug">
                  {video.title}
                </h3>
              </a>
            ))}
